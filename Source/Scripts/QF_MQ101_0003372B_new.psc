...
;NEXT FRAGMENT INDEX 396
Scriptname QF_MQ101_0003372B_new Extends Quest Hidden
...
;BEGIN ALIAS PROPERTY Cart1Spawn
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_Cart1Spawn Auto
;END ALIAS PROPERTY
...
;BEGIN ALIAS PROPERTY CivilianSkalei
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_CivilianSkalei Auto
;END ALIAS PROPERTY
...
;BEGIN ALIAS PROPERTY CivilianJacob
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_CivilianJacob Auto
;END ALIAS PROPERTY
...
;BEGIN ALIAS PROPERTY HadvarLookIntoLedgerMarker
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_HadvarLookIntoLedgerMarker Auto
;END ALIAS PROPERTY
...
;BEGIN ALIAS PROPERTY Cart2Spawn
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_Cart2Spawn Auto
;END ALIAS PROPERTY
...
;BEGIN ALIAS PROPERTY SoldierFortAssistant
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_SoldierFortAssistant Auto
;END ALIAS PROPERTY
...
;BEGIN FRAGMENT Fragment_372
Function Fragment_372()
;BEGIN AUTOCAST TYPE MQ101QuestScript
Quest __temp = self as Quest
MQ101QuestScript kmyQuest = __temp as MQ101QuestScript
;END AUTOCAST
;BEGIN CODE
; Start Torri Walking up to Torolf -> SetStage 5
APStage5Scene.Forcestart()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
; No point for this tutorial in AP, I guess
;END CODE
EndFunction
;END FRAGMENT
...
if ((Self as Quest) as APMQ101Controller).isintrotransition
...
Alias_Cart1.GetReference().DisableNoWait()
Alias_Cart2.GetReference().DisableNoWait()
...
;BEGIN FRAGMENT Fragment_353
Function Fragment_353()
;BEGIN AUTOCAST TYPE APMQ101
Quest __temp = self as Quest
APMQ101 kmyQuest = __temp as APMQ101
;END AUTOCAST
;BEGIN CODE
;trigger Alduin reactions for the chopping block
Alias_Headsman.GetActorRef().PlayIdle(IdleExecutionerAlduinReactionDeath)

; knockout the Player & destroy Helgen. Play Title Sequence
kmyQuest.knockoutPlayer()

; Changed kmyQuest to point at our own mainscript and handle stuff there. Cant use the Vanilla Anims
; here unfortunately as the Player isnt using the chop chop block
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN FRAGMENT Fragment_395
Function Fragment_395()
;BEGIN CODE
;enable the HUD
...
;BEGIN FRAGMENT Fragment_394
Function Fragment_394()
;BEGIN CODE
; Dont showracemenu in the edited Intros
;END CODE
EndFunction
;END FRAGMENT

;BEGIN FRAGMENT Fragment_389
Function Fragment_389()
;BEGIN AUTOCAST TYPE APMQ101Controller
Quest __temp = self as Quest
APMQ101Controller kmyQuest = __temp as APMQ101Controller
;END AUTOCAST
;BEGIN CODE
; debug.trace(self + "stage 10, AP 6")
; disable first person geometry, save & controls
Game.ShowFirstPersonGeometry(false)
Game.SetInChargen(true, true, true)
Game.DisablePlayerControls(abMovement =true, abFighting = true, abCamSwitch = true, abLooking = false, abSneaking = true, abMenu = true, abJournalTabs= true)
...
If (kmyQuest.isintrotransition)
  ObjectReference chest = Alias_PlayerGearChest.GetReference()
  Player.RemoveAllItems(chest)
  chest.EnableNoWait()
Else
...
Player.EquipItem(PrisonerCuffsPlayer, abSilent = true)
...
Alias_Ulfric.GetRef().MoveTo(kmyQuest.Cart2UlfricMarker)
Alias_StormcloakPrisoner01.GetRef().Moveto(kmyQuest.Cart1Prisoner01Marker)
Alias_StormcloakPrisoner02.GetRef().Moveto(kmyQuest.Cart1Prisoner02Marker)
Alias_StormcloakPrisoner03.GetRef().Moveto(kmyQuest.Cart1Prisoner03Marker)
Alias_StormcloakPrisoner04.GetRef().Moveto(kmyQuest.Cart1Prisoner04Marker)
...
; play intro music
IntroMusic.Add()
((Self as Quest) as MQ101QuestScript).CartSoundInstanceID = CartSound.Play(Player)
; open gates & start scene
NorthGate.SetOpen(true)
Scene1.Start()

; Fallback since Stage12 doesnt properly fire if intro starts near Helgen
int timeout = 10
While timeout > 0
  If(GetStage() >= 12)
    return
...
; fallback because hadvar sometimes fails to spawn correctly in the initial path to helgen
Actor hadvar = Alias_Hadvar.GetActorRef()
If (hadvar.GetDistance(kmyQuest.HadvarLedgerMarker) > 300)
hadvar.MoveTo(kmyQuest.HadvarLedgerMarker)
EndIf
hadvar.EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
;END AUTOCAST
;BEGIN CODE
;debug.trace("MQ101 stage 0 -- AP edited start")

; We still set GameHour to 7 to let the Player start at a new day
GameHour.SetValue(7)

; Now we just tell our own mainscript that we started a new game. Were done here for now
kmyQuest.GameStart()
;END CODE
EndFunction
;END FRAGMENT
...
; NOTE: Some conditions are listening for this Stage
; Setting it will glitch out the intro
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN FRAGMENT Fragment_351
Function Fragment_351()
;BEGIN AUTOCAST TYPE APMQ101Controller
Quest __temp = self as Quest
APMQ101Controller kmyQuest = __temp as APMQ101Controller
;END AUTOCAST
;BEGIN CODE
; enable Intro, wait for Player to leave Inn
GameHour.Value += 3 ;game time

; enable Collisions to avoid the Player running out of town
CollisionWall.EnableNoWait()
;END CODE
EndFunction
;END FRAGMENT
...
; Get Headsman & Priest moving
Alias_Headsman.GetActorReference().EvaluatePackage()
Alias_Priest.GetActorReference().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN FRAGMENT Fragment_365
Function Fragment_365()
;BEGIN AUTOCAST TYPE APMQ101Controller
Quest __temp = self as Quest
APMQ101Controller kmyQuest = __temp as APMQ101Controller
;END AUTOCAST
;BEGIN CODE
; make sure Civilians are disabled & Intro quests stop
Alias_ImperialSoldierHelgen01.GetReference().Disable()
Alias_ImperialSoldierHelgen02.GetReference().Disable()
Alias_CivilianGunnar.GetReference().Disable()
Alias_CivilianIngrid.GetReference().Disable()
Alias_CivilianMatlara.GetReference().Disable()
Alias_CivilianTorolf.GetReference().Disable()
Alias_CivilianTorri.GetReference().Disable()
Alias_CivilianVilod.GetReference().Disable()

kmyQuest.Stage1000()
kmyQuest.DialogueHelgenScr.ShutDown()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN FRAGMENT Fragment_388
Function Fragment_388()
;BEGIN CODE
; AP additions

; Have the Soldier thats standing with the Captain walk towards his spot now too
Alias_SoldierFortAssistant.GetActorRef().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN FRAGMENT Fragment_384
Function Fragment_384()
;BEGIN CODE
; disable Collisions, allowing carriages to move to the plazza
...
;END AUTOCAST
;BEGIN CODE
; Same Story as before.. not changing any logic, just avoiding anything being done to the player
...
kmyQuest.ExitCart(Alias_Prisoner02, 4)
...
Alias_Hadvar.TryToMoveTo(HadvarKeepMarker1)
Alias_Hadvar.GetReference().Enable()
...
;BEGIN FRAGMENT Fragment_392
Function Fragment_392()
;BEGIN CODE
; player opened chest
...
;BEGIN FRAGMENT Fragment_367
Function Fragment_367()
;BEGIN AUTOCAST TYPE APMQ101
Quest __temp = self as Quest
APMQ101 kmyQuest = __temp as APMQ101
;END AUTOCAST
;BEGIN CODE
; Swap state of objects added by AP
kmyQuest.APMarker.Enable()

; Disable collision walls otherwise Alduin gets stuck flying back into town
borderCollision.Disable()

; Make sure Torolf can be killed by Alduin
Alias_CivilianTorolf.GetActorRef().GetActorBase().SetEssential(false)
; disable NPC we no longer need
Alias_CivilianSkalei.GetReference().DisableNoWait()
Alias_SoldierFortAssistant.GetRef().DisableNoWait()

; enable Helgen Keep Auto Door
HelgenAutoDoor.EnableNoWait()
;END CODE
EndFunction
;END FRAGMENT
...
actor myPrisoner01 = Alias_Prisoner01.GetActorRef()
Actor myUlfric = Alias_Ulfric.GetActorRef()
Actor myPlayer = Alias_Prisoner02.GetActorRef() ;Game.GetPlayer()
ObjectReference myCart2 = Alias_Cart2.GetRef()
...
; Enable everyone, Cart1
myImperialSoldier01.EnableNoWait()
myRalof.EnableNoWait()
myPrisoner01.EnableNoWait()
myUlfric.EnableNoWait()
myPlayer.EnableNoWait()

;Enable everyone, Cart2
myImperialSoldier02.EnableNoWait()
myStormcloakPrisoner01.EnableNoWait()
myStormcloakPrisoner02.EnableNoWait()
myStormcloakPrisoner03.EnableNoWait()
myStormcloakPrisoner04.EnableNoWait()

;Other NPCs
Alias_Hadvar.GetReference().EnableNoWait()
Alias_ImperialSoldierFort01.GetReference().EnableNoWait()
Alias_Priest.GetReference().EnableNoWait()
Alias_Headsman.GetReference().EnableNoWait()
Alias_Justiciar01.GetReference().EnableNoWait()
Alias_Justiciar02.GetReference().EnableNoWait()
...
;BEGIN CODE
; again this is primarily just to disable all the stuff that would happen to the player
...
;END AUTOCAST
;BEGIN CODE
; Only add music in the non-custom Intro, otherwise we
; have the BossChargen music playing during title sequence
...
;BEGIN FRAGMENT Fragment_380
Function Fragment_380()
;BEGIN CODE
; Disable Matlaras Intro Dialogue
;END CODE
EndFunction
;END FRAGMENT

;BEGIN FRAGMENT Fragment_374
Function Fragment_374()
;BEGIN AUTOCAST TYPE APMQ101Controller
Quest __temp = self as Quest
APMQ101Controller kmyQuest = __temp as APMQ101Controller
;END AUTOCAST
...
;END AUTOCAST
;BEGIN CODE
; Player leaving Inn. Enable Carts & get everything going
;Debug.Trace("MQ101: SetStage 10 - AP Edit")

; Disable Fast Travel & Wait
Game.EnableFastTravel(false)
Game.SetInChargen(false, true, false)

;Enable Helgen Border Collissions
borderCollision.Enable()
...
; move everybody into position
Alias_ImperialSoldierHelgen01.GetReference().MoveToMyEditorLocation()
Alias_ImperialSoldierHelgen02.GetReference().MoveToMyEditorLocation()
Alias_Elenwen.GetRef().MoveTo(Alias_ElenwenStartMarker.GetRef())
Alias_GeneralTullius.GetRef().MoveTo(Alias_TulliusStartMarker.GetRef())
Alias_GeneralTullius.GetActorRef().EvaluatePackage()
...
; play cart sounds
kmyquest.CartSoundInstanceID = CartSound.Play(Alias_Prisoner02.GetRef())
; open gates -- not opening the east gate for now
;EastGate.SetOpen(true)
NorthGate.SetOpen(true)
; close west gate
WestGate.SetOpen(false)
Scene1.Start()
...
;BEGIN CODE
; We keep the notifications disabled as otherwise the Player would get "Your hands are tied"
; messages, which doenst really make sense since the Players hands arent tied
...
;BEGIN FRAGMENT Fragment_381
Function Fragment_381()
;BEGIN AUTOCAST TYPE APMQ101Controller
Quest __temp = self as Quest
APMQ101Controller kmyQuest = __temp as APMQ101Controller
;END AUTOCAST
;BEGIN CODE
; Start of AP Vanilla Intro branch
kmyQuest.MQQuickStart.Value = 6
kmyQuest.CharGenFXTrigger.EnableNoWait()
GameHour.Value = 7

; Torri and Torolf cant get infront of the Inn or smth? Idk. Moving them to Editor Loc
Alias_CivilianTorolf.GetReference().MoveToMyEditorLocation()
Alias_CivilianTorolf.GetActorRef().EvaluatePackage()
Alias_CivilianTorri.GetReference().MoveToMyEditorLocation()
Alias_CivilianTorri.GetActorRef().EvaluatePackage()

; Puttin the player onto the carriage
Alias_Prisoner02.ForceRefTo(Game.GetPlayer())
; Swap out the carts
Alias_Cart1.ForceRefTo(kmyQuest.Cart1)
Alias_Cart2.ForceRefTo(kmyQuest.Cart2)
; Discard players items if in Start Cell, otherwise store them in Keep
kmyQuest.isintrotransition = Game.GetPlayer().GetParentCell() != kmyQuest.StartCell

; Get all the NPC in place
SetStage(5)
; .. and start the Intro
SetStage(10)
;END CODE
...
;END AUTOCAST
;BEGIN CODE
; This is again not really an edit to any logic but we have to replace the Player with our Khajit Dummy
...
Alias_Prisoner02.GetActorRef().PlayIdle(kmyQuest.IdleCartPassengerCIdle)
...
;BEGIN FRAGMENT Fragment_377
Function Fragment_377()
;BEGIN AUTOCAST TYPE APMQ101Controller
Quest __temp = self as Quest
APMQ101Controller kmyQuest = __temp as APMQ101Controller
;END AUTOCAST
...
;BEGIN FRAGMENT Fragment_390
Function Fragment_390()
;BEGIN CODE
; Adding cart ride specific stuff that isnt needed in APs default start
Game.SetHudCartMode()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN FRAGMENT Fragment_383
Function Fragment_383()
;BEGIN AUTOCAST TYPE APMQ101Controller
Quest __temp = self as Quest
APMQ101Controller kmyQuest = __temp as APMQ101Controller
;END AUTOCAST
;BEGIN CODE
; Get rid of the pre-intro exclusive AP assets
HelgenDisEnabMarker.Disable()
Alias Messenger = kmyQuest.DialogueHelgenScr.GetAliasByName("Messenger")
(Messenger as ReferenceAlias).GetReference().DisableNoWait()

; Move/Enable by AP added NPC to their correct Position
Alias_CivilianSkalei.GetReference().MoveTo(kmyQuest.SkaleiPlazzaSeat)
Alias_SoldierFortAssistant.GetRef().EnableNoWait()

; kick the Captain out of the keep, otherwise they take too long to get to their location
Alias_ImperialSoldierFort01.GetReference().MoveTomyEditorLocation()

; These have been replaced by common NPC until the Intro starts
Alias_ImperialSoldierHelgen01.GetReference().EnableNoWait()
Alias_ImperialSoldierHelgen02.GetReference().EnableNoWait()
Alias_HelgenArcher01.GetRef().EnableNoWait()
Alias_HelgenArcher02.GetRef().EnableNoWait()

Alias_Priest.GetReference().MoveTo(kmyQuest.HelgenWatchtower)
Alias_Headsman.GetReference().MoveTo(kmyQuest.HelgenKeep)

; Make sure all Civilians get to their Position
Actor Gunnar = Alias_CivilianGunnar.GetRef() as Actor
Gunnar.MoveTo(kmyQuest.GunnarIntroPos)
Gunnar.EvaluatePackage()
Actor Ingrid = Alias_CivilianIngrid.GetRef() as Actor
Ingrid.MoveTomyEditorLocation()
Ingrid.EvaluatePackage()
Actor Vilod = Alias_CivilianVilod.GetRef() as Actor
Vilod.MoveToMyEditorLocation()
Vilod.EvaluatePackage()
Alias_CivilianMatlara.GetActorRef().EvaluatePackage()
Alias_CivilianTorolf.GetActorRef().EvaluatePackage()
Alias_CivilianTorri.GetActorRef().EvaluatePackage()
;END CODE
EndFunction
...
;BEGIN FRAGMENT Fragment_391
Function Fragment_391()
;BEGIN AUTOCAST TYPE APMQ101Controller
Quest __temp = self as Quest
APMQ101Controller kmyQuest = __temp as APMQ101Controller
;END AUTOCAST
;BEGIN CODE
; set chest objective if applicatable
if kmyQuest.isintrotransition
...
;BEGIN FRAGMENT Fragment_363
Function Fragment_363()
;BEGIN CODE
; player in keep now
...
;BEGIN FRAGMENT Fragment_355
Function Fragment_355()
;BEGIN CODE
Alias_Prisoner02.GetActorRef().DisableNoWait()
Alias_Headsman.GetReference().DisableNoWait()
...
; -- New Properties added by Alternate Perspective

ObjectReference Property HelgenAutoDoor  Auto

ObjectReference Property WestGate  Auto

ObjectReference Property ElenwenHorse  Auto

ObjectReference Property CollisionWall  Auto

ObjectReference Property HelgenDisEnabMarker  Auto

ObjectReference Property CharGenTrigger  Auto

ObjectReference Property borderCollision  Auto

Scene Property APStage5Scene  Auto  
